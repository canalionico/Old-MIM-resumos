...
50% das massas renais são diagnósticadas de forma incidental por exames de imagem como o USG.
...
## Quadro clínico
Os sinais e sintomas não auxiliam no diagnóstico das massas renais.

- __Tríade clássica__: (só em 10% dos casos)
  - Hematúria
  - Massa renal palpável
  - Dor em flanco
- Dor abdmonal, lombar ou no flanco
- Hematúria
- ITU
- HAS
- Hemorragia
...
## Lesões benignas
Lesões mesenquimais benignas do rim, incluindo leiomiomas, fibromas, lipomas e hamartomas, são relativamente incomuns.

- __Cisto simples__
  - As mais comuns (70%)
  - Podem ser múltiplos ou solitários
  - 50% dos paciente < 50 anos possuem
  - Sintomáticos ou assintomáticos
- __Adenomas__
  - pequenas lesões geralmente identificadas em autópsias (muito pequenas para a detecção com exames de imagem)
- __Oncocitomas__
  - 3-7% de todas as massas renais sólidas
  - Tumores epiteliais derivados dos túbulos distais dos néfrons
  - 3-32% das vezes coexistem com CCR
  - Dificil de diferenciar com o CCR
...
- __Nefroma cístico multilocular__
  ...
  - Sintomatologia é mais frequente em adultos do que crianças
  - Não dá para diferenciar com clínica ou imagem do CCR em adultos ou tumor de Wilms cístico em crianças
  - Tratamento semelhante ao CCR
...
- Epidemiologia
  - 85% de todas as neoplasias renais primárias
  - O mais letal dos CAs urológicos
  - H2:1M
  - ↑50-70 anos
  - 40-50% encontrados incidentalmente
- Etiologia
  - Origem no túbulo contorcido proximal
- Fatores de risco
  - Tabagismo
  - Obesidade
  - Doença cística
...
Não existe indicação de tratamento adjuvante ou neoadjuvante para pacientes com câncer renal localizado. Nenhum tratamento sistêmico é satisfatório para o carcinoma renal avançado (metastático ou irressecável).
...
- Nos casos de nódulo renal ou indeterminado deve-se continuar a investigação com a TC.

### TC
- As massas renais sólidas que captam contraste na TC podem ser consideradas malignas
- É possível avaliar:
  - Densidade tecidual
  - Vascularização de massas renais
  - Diferenciação dos cistos renais
  - Auxiliar a programação cirúrgica
- __Classificação de Bosniak__
  - Tipo I: cisto benigno simples de parede fina, não septado, sem calcificações ou componentes sólidos. Lesão bem delimitada, adjacente ao parênquima sem
...
- Distinção entre carcinoma e oncocitoma (apresenta cápsula e cicatriz central estrelada)
- Método de escolha em nefropatas crônicos e pacientes com alergia ao contraste iodado
