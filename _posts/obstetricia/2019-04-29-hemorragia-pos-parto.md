...
## Prevenção
Primeiramente revisar o canal de parto. Em seguida, a prevenção se baseia na administração de ocitocina (10UI), IM, logo após a expulsão fetal. Também pode-se optar pela infusão IV de 10-40IU em 1.000mL de soro fisiológico.
...
## Etiologias
- Regra dos 4T (as 4 principais causas)
...
- Fatores de risco
  ...
  - Polidrâmnio
  - Macrossomia
  - Distócia do trabalho de parto
  - Prolongamento do 2o período
  - Multiparidade
...
- Principais causas:
  ...
  - Partos precipitados
- Conduta:
  - Sempre revisar o canal de parto!
...
Quando a placenta demora mais de 30min para se desprender, já é considerada uma retenção. É muito comum nos casos de atonia uterina. Uma cesárea anterior aumenta em 3x o risco de desenvolver esta condição.

- Placenta acreta: aderida diretamente ao endométrio
- Placenta increta: quando penetra profundamente no miométrio
- Placenta precreta: quando atinge a serosa uterina e órgãos como a bexiga
- Conduta:
...
### Inversão uterina
É a causa mais incomum de HPP, porém de significativa gravidade. Resulta da invaginação do fundo de útero que pode chegar até mesmo à ultrapassar a vagina e se exteriorizar pela vulva.

É mais frequente em multíparas, pacientes com acretismo placentário e que foram submetidas a exagerada tração de cordão e compressão do fundo uterino.

### Ruptura uterina
Cada vez mais incomum, corresponde à ruptura da parede uterina. Se for no local da cicatriz de cesárea, é chamada de _deiscência da cicatriz_.

## Hemorragia tardia
### Retenção de fragmentos placentários
É a causa mais comum de HPP tardia, impedindo a involução uterina normal e, em conjunto, a regeneração endometrial. As perdas sanguíenas podem ser, ora escassas, ora abundantes. A infecção também vẽm a ser um grande problema.

### Hematomas


![tabela](/assets/obstetricia/hpp/tab.png)
...
- Massagear o útero
  - Manobra de Hamilton
- Curagem: exploração e remoção digital de restos placentários
...
TERMINAR TRATAMENTO PELO LIVRO DO CISAM
