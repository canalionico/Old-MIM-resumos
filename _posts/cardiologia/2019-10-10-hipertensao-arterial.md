...
**Hipertensão arterial sistêmica:** PA maior ou igual, de forma sustentada, a 140 x 90 mmHg.

**Pré-hipertensão:** caracterizada por PA sistólica (PAS) entre 121 e 139 e/ou PA diastólica (PAD) entre 81 e 89 mmHg.

## Epidemiologia

A pressão arterial sistólica tende a, fisiologicamente, se elevar com a idade (os vasos ficam mais rígios, não se dilatam, reduzindo a sua área e elevando a pressão nas paredes), sendo que a pressão diastólica, a partir dos 55 anos, começa a declinar. Em idosos, os níveis são discretamente maiores nas mulheres.

No Brasil, a prevalência média é de 32,5% da população, subindo para 60% entre os idosos. Somado ao grande número de pacientes, a taxa de controle ainda é muito baixa (em torno de 20-30%).

EUA, 2015: HA estava presente em 69% dos pacientes com primeiro episódio de IAM, 77% de AVE, 75% com IC e 60% com DAP.5 A HA é responsável por 45% das mortes cardíacas e 51% das mortes decorrentes de AVE.

<p class="caixa-title">Fatores de risco</p><div class="caixa" markdown="1">
* Idade
* Sexo
  * Mais prevalente em homens;
  * Mas quando as mulheres entram na menopausa, superam os homens em prevalência.
  * De forma geral, é mais prevalente em mulheres*.
* Etnia: em negros é mais grave e mais precoce;
* Obesidade;
* Sedentarismo;
* Elevada ingestão de sal e álcool, baixo consumo de K e Ca;
* Fatores genéticos: não parece ter uma relação clara;
* Prematuridade;
...
Início precoce (idade < 30 anos) ou tar-
dio (idade > 50 anos). Alguns autores
citam como limite antes dos 20 e acima
dos 55 anos.
...
* **Coração:** desvio do ictus, presença de B3 ou B4, sopros, arritmias, edema periférico, crepitações pulmonares. Sopros abdominais ou torácicos (renovascular, coartação de aorta, doença da aorta ou ramos)
...
* **Abdomen:** rins aumentados (rim policístico).

Avaliar sinais que sugerem causas secundárias.
...
Para o cálculo da depuração de creatinina, utiliza-se a **fórmula de Cockroft-Gault**:
RFG-e (ml/min) = [140 - idade] x peso (kg) /creatinina plasmática (mg/ dL) x 72 para homens; para mulheres, multiplicar o resultado por 0,85.

Estágios de DRC:

![DRC](/assets/cardiologia/drc.jpeg)

### Exames de imagem

**Radiografia de tórax:** avaliação de hipertensos com comprometimento da aorta quando o ecocardiograma não está disponível

**Ecocardiograma:** mais sensível do que o ECG no diagnóstico de HVE. Analisa a função sistólica e diastólica.

**Teste ergométrico:** suspeita de DAC estável, DM ou antecedente familiar para DAC em pacientes com PA controlada.

## Diagnóstico

A PA deve ser medida no braço, devendo-se utilizar manguito adequado à sua circunferência. Na suspeita de HA secundária à coartação da aorta, a medição deverá ser realizada nos MMII, utilizando-se manguitos apropriados.
...
**Diagnóstico no consultório:** a PA deve estar acima dos valores normais em pelo menos duas medições por visita, em pelo menos duas visitas!

Recomenda-se, pelo menos, a medição da PA a cada 2 anos para os adultos com PA ≤ 120/80 mmHg, e anualmente para aqueles com PA > 120/80 mmHg e < 140/90 mmHg.

A partir dos 3 anos todas crianças devem ter suas medidas de PA aferidas pelo menos anualmente. Nas crianças é necessário avaliar as tabelas de crascimento e percentil por idade e altura.

Na suspeita de HA secundária
à coartação da aorta, a medição deverá ser realizada nos MMII.

<p class="caixa-title">Hipotensão ortostática</p><div class="caixa" markdown="1">
Deve ser suspeitada em pacientes **idosos**, diabéticos, disautonômicos e naqueles em uso de medicação anti-hipertensiva. Assim, particularmente nessas condições, deve-se medir, em seguida, a PA com o paciente **de pé, após 3 minutos**, sendo a hipotensão ortostática definida como a **redução da PAS > 20 mmHg ou da PAD > 10 mmHg**.
</div>

### Técnica

20 etapas para a correta aferição da PA:

1. Explicar o procedimento ao paciente e deixá-lo em repouso de 3 a 5 minutos em ambiente calmo. Deve ser instruído a não conversar durante a medição;
...
12. Proceder à deflação lentamente (velocidade de **2 mmHg por segundo**)*;
...
15. Auscultar cerca de 20 a 30 mmHg abaixo do último som para confirmar seu desaparecimento e depois proceder à deflação rápida e completa*;
16. Se os batimentos persistirem até o nível zero, determinar a PAD no abafamento dos sons (fase IV de Korotkoff) e anotar valores da PAS/PAD/zero*;
17. Realizar pelo menos duas medições, com intervalo em torno de um minuto. Medições adicionais deverão ser realizadas se as duas primeiras forem muito diferentes. Caso julgue adequado, considere a média das medidas;
18. Medir a pressão em ambos os braços na primeira consulta e usar o valor do braço onde foi obtida a maior pressão como referência;
19. Informar o valor de PA obtido para o paciente;
20. Anotar os valores exatos sem “arredondamentos” e o braço em que a PA foi medida.

![Correção da PA de acordo com a circunferência do braço](/assets/cardiologia/correcao-pa.jpeg)
![Manguito ideal de acordo com a circunferência do braço](/assets/cardiologia/circunferencia-manguito.jpeg)

Em braços com circunferência superior a 50 cm, onde não há manguito disponível, pode-se fazer a medição no antebraço, auscultando o pulso radial.
...
A MAPA e a MRPA são os métodos habitualmente utilizados para realizar as medições fora do consultório. Ambas fornecem informações semelhantes da PA, **porém só a MAPA avalia a PA durante o sono**. Recomenda-se MRPA ou MAPA para estabelecimento do diagnóstico, identificação da HAB e da HM.

![indicações do MAPA](/assets/cardiologia/indicacoes-mapa.jpeg)

### Valores diagnósticos

![Valores diag](/assets/cardiologia/diag-has.jpeg)
![Flux](/assets/cardiologia/diag-flux-has.jpeg)

### Classificação

* **Normotensão:** nem em casa e nem no consultório;
  * As medidas de consultório são ≤ 120/80 mmHg e as medidas fora dele (MAPA ou MRPA) confirmam os valores considerados normais.
...
* **Pré-hipertensão (PH):** PAS entre 121 e 139 e/ou PAD entre 81 e 89 mmHg;
* **Hipertensão sustentada:** em casa e no consultório;
* **Hipertensão mascarada (HAB):** só em casa;
  * Prevalência da 13%;
  * A incidência de eventos cardiovasculares é duas vezes maior na HM do que na normotensão, sendo comparada à da HAS!
* **Hipertensão do avental branco (HAB):** só no consultório;
  * É a diferença de pressão entre as medidas obtidas no consultório e fora dele, desde que essa diferença seja igual ou superior a 20 mmHg na PAS e/ou 10 mmHg na PAD;
  * Prevalência global de 13%.
* **Hipertensão sistólica isolada (HSI):** é definida como PAS aumentada com PAD normal;
  * Junto da pressão de pulso (PP), são importantes fatores de risco cardiovascular em pacientes de meia-idade e idosos.
...
PA não controlada apesar do uso de três dro-
gas em dose otimizada, sendo uma delas da
classe dos diuréticos.

## Estratificação de risco

Deve ser realizado para todos os pacientes hipertensos. Irá impactar na decisão terapêutica e na análise do prognóstico.

### Fatores de risco cardiovascular adicional

* Idade (homem > 55 e mulheres > 65 anos);
* Tabagismo;
* Dislipidemias: CT > 190, TG > 150, LDL-c > 115, HDL-c < 40 H e < 46 M.
* Resistência à insulina: Gj 100-125, TOTG 140-199 2h, HbsAg1 5,7 – 6,4%;
* Obesidade: IMC ≥ 30, CA ≥ 102 H ou ≥ 88 M;
* História familiar (1º grau) prematura de DCV: homens < 55 anos e mulheres < 65 anos

![Flux](/assets/cardiologia/estratificacao-has.jpeg)
...
* Hipertrofia ventricular esquerda
  ...
  * IECO: IMVE > 115 g/m² nos homens ou > 95 g/m² nas mulheres;
* EMI da carótida > 0,9 mm ou placa carotídea;
* VOP carótido-femoral > 10 m/s;
* ITB < 0,9;
* DRC estágio 3 (RFG-e 30-60 mL/min/1,73m²);
...
Estima o risco de o indivíduo apresentar um evento CV (DAC, AVE, DAP, IC) em 10 anos. Não apenas para pacientes hipertensos, mas para qualquer indivíduo entre 30 e 74 anos. É diferente para mulheres e homens.

* **Alto risco:** H > 20% e M> 10%;
* **Risco intermediário:** H entre 5% e 20%, M e entre 5% e 10%;
...
![Flux](/assets/cardiologia/aterosclerotica.jpeg)


Se o paciente não se enquadra na primeira etapa acima, deve-se calcular seu ERG:

![Flux](/assets/cardiologia/ergh.jpeg)
![Flux](/assets/cardiologia/ergm.jpeg)

Os pacientes de risco intermediário que apresentam quaisquer fatores agravantes citados na Tabela 8 são reclassificados para "alto risco".

![Flux](/assets/cardiologia/tab8.jpeg)
![Flux](/assets/cardiologia/sm.jpeg)

Fluxogama para resumir o resultado final do escore de risco global (ERG):

![Flux](/assets/cardiologia/flux-erg.jpeg)

## Tratamento

### Não medicamentoso

Extremamente importante, seja associado ou não ao tratamento medicamentoso. Admite-se que a
terapia não farmacológica isoladamente não possa promover reduções da PA suficientes para alcance da meta pressórica recomendada

* Perda ponderal (principal!),
* Dieta DASH (maior ingesta de potássio, magnésio e cálcio);
* Redução na ingesta de sal (dieta hipossódica);
* Atividade física;
* Cessar tabagismo;
  * Não há evidências que a cessação do tabagismo reduza a PA, mas diminui os fatores de risco.
...
![Indicação](/assets/cardiologia/mev-has.jpeg)
...
exercícios físicos em intensidade moderada. Além disso, todo
hipertenso que for se engajar em esportes competitivos ou
...
**Em idosos:** recomenda‐se o início da terapia farmacológica anti-hipertensiva em idosos a partir de níveis de PAS ≥ 140 mmHg, desde que bem tolerado e avaliando-se as condições gerais do indivíduo. Nos muito idosos, ou seja, naqueles com idade ≥ 80 anos, o limite para início da terapia farmacológica aumenta para uma PAS ≥ 160 mmHg.

> O mecanismo mais comum da HA no idoso é o enrijecimento da parede arterial dos grandes vasos, levando a aumento predominante da PAS, com manutenção ou queda da PAD.

**Abordagem de jovens com hipertensão sistólica isolada:** a HSI é frequente em jovens saudáveis do sexo masculino
com menos de 30 anos e pode estar associada à pressão central normal. Nesses casos, o tratamento não teria benefícios
significativos, sendo recomendada a adoção de medidas não medicamentosas, com monitorização de LOA. A terapia farmacológica deve ser iniciada caso seu risco CV seja alto. No caso de elevação da PAD, adotam-se os mesmos critérios de tratamento da população em geral.

![Indicação](/assets/cardiologia/indicacoes-tto-has.jpeg)
...
VII Diretriz brasileira: depende do estágio da HAS e fatores de risco.
...
* Recomenda-se meta pressórica inferior a 130/80 mmHg para pacientes de alto risco CV.
* Em diabéticos e em pacientes com DAC, a meta deve ficar numa faixa mais estreita de segurança, < 130/80 mmHg, mas não < 120/70 mmHg.
* Hipertensos com PA no estágio 3, embora de alto risco CV, deverão ter como meta pressórica a PA < 140/90 mmHg, pois não há evidências científicas que suportem reduções mais intensas da PA.
* Para hipertensos idosos ≥ 80 anos, não há evidência de benefícios proporcionados por cifras < 140 mmHg, além de aumentar a possibilidade de efeitos adversos.
...
1. 7ª Diretriz Brasileira de HAS
2. Medcurso
3. Aula
